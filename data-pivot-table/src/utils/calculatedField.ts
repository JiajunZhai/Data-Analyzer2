import type { DataRow, CalculatedField } from '../types';
...
export function calculateMetricFromAggregates(
  ...
  [...metric.fields].sort((a, b) => b.length - a.length).forEach(fieldName => {
...
export function calculateField(
  ...
  [...fields].sort((a, b) => b.length - a.length).forEach(fieldName => {
