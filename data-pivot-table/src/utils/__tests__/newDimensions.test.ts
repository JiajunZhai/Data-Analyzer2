...
describe('新维度字段验证：广告类型、广告变现渠道、生命周期', () => {
  ...
  const mockData: DataRow[] = [
    { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 注册用户: 500, 广告类型: 'banner', 广告变现渠道: 'admob', 生命周期: 'D0', 曝光人数: 300, 曝光次数: 1000, 广告收益: 12.5, 点击次数: 80 },
    { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 注册用户: 400, 广告类型: 'interstitial', 广告变现渠道: 'admob', 生命周期: 'D0', 曝光人数: 250, 曝光次数: 600, 广告收益: 25.0, 点击次数: 50 },
    { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 注册用户: 300, 广告类型: 'banner', 广告变现渠道: 'unity', 生命周期: 'D0', 曝光人数: 180, 曝光次数: 500, 广告收益: 5.0, 点击次数: 30 },
    { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 注册用户: 450, 广告类型: 'banner', 广告变现渠道: 'admob', 生命周期: 'D1', 曝光人数: 280, 曝光次数: 900, 广告收益: 10.0, 点击次数: 70 },
    { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'DE', 版本: '1.0', 渠道: 'facebook', 注册用户: 200, 广告类型: 'rewarded', 广告变现渠道: 'applovin', 生命周期: 'D0', 曝光人数: 150, 曝光次数: 400, 广告收益: 18.0, 点击次数: 45 },
  ];
  ...
  describe('字段检测', () => {
    ...
    it('新旧字段同时存在时应全部正确识别', () => {
      const headers = ['日期', '应用', '标准广告场景', '广告类型', '广告变现渠道', '生命周期', '注册用户', '广告收益'];
      const fields = detectFieldTypes(headers, mockData);

      const dimensions = fields.filter((f) => f.type === 'dimension');
      expect(dimensions.map((f) => f.name)).toEqual(
        expect.arrayContaining(['日期', '应用', '标准广告场景', '广告类型', '广告变现渠道', '生命周期'])
      );

      const measures = fields.filter((f) => f.type === 'measure');
      expect(measures.map((f) => f.name)).toEqual(
        expect.arrayContaining(['注册用户', '广告收益'])
      );
    });
  });
  ...
  describe('注册用户半可加去重', () => {
    it('跨广告类型聚合时注册用户应取 max 而非 sum', () => {
      const data: DataRow[] = [
        { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 广告类型: 'banner', 广告变现渠道: 'admob', 生命周期: 'D0', 注册用户: 500, 广告收益: 12.5, 曝光人数: 300, 曝光次数: 1000, 点击次数: 80 },
        { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 广告类型: 'interstitial', 广告变现渠道: 'admob', 生命周期: 'D0', 注册用户: 500, 广告收益: 25.0, 曝光人数: 250, 曝光次数: 600, 点击次数: 50 },
      ];
    ...
    it('跨生命周期聚合时注册用户应取 max 而非 sum', () => {
      const data: DataRow[] = [
        { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 广告类型: 'banner', 广告变现渠道: 'admob', 生命周期: 'D0', 注册用户: 500, 广告收益: 12.5, 曝光人数: 300, 曝光次数: 1000, 点击次数: 80 },
        { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 广告类型: 'banner', 广告变现渠道: 'admob', 生命周期: 'D1', 注册用户: 450, 广告收益: 10.0, 曝光人数: 280, 曝光次数: 900, 点击次数: 70 },
      ];
      ...
      const result = aggregateData(
        ...
        [createPivotField('生命周期', 'dimension')],
        [],
        [createPivotField('注册用户', 'measure'), createPivotField('广告收益', 'measure'), createPivotField('曝光人数', 'measure')]
      );
    ...
    it('跨广告变现渠道聚合时注册用户应取 max 而非 sum', () => {
      const data: DataRow[] = [
        { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 广告类型: 'banner', 广告变现渠道: 'admob', 生命周期: 'D0', 注册用户: 500, 广告收益: 12.5, 曝光人数: 300, 曝光次数: 1000, 点击次数: 80 },
        { 日期: '2026-06-10', 应用: 'fr006b', 国家: 'US', 版本: '1.0', 渠道: 'google', 广告类型: 'banner', 广告变现渠道: 'unity', 生命周期: 'D0', 注册用户: 500, 广告收益: 5.0, 曝光人数: 180, 曝光次数: 500, 点击次数: 30 },
      ];
  ...
  describe('新维度筛选候选值', () => {
    it('getUniqueValues 应返回广告类型的唯一值', () => {
      expect(getUniqueValues(mockData, '广告类型').sort()).toEqual(['banner', 'interstitial', 'rewarded']);
    });

    it('getUniqueValues 应返回广告变现渠道的唯一值', () => {
      expect(getUniqueValues(mockData, '广告变现渠道').sort()).toEqual(['admob', 'applovin', 'unity']);
    });
  ...
  describe('新旧维度共存', () => {
    it('标准广告场景和广告类型同时作为维度时应正确聚合', () => {
      const data: DataRow[] = [
        { 日期: '2026-06-10', 应用: 'fr006b', 标准广告场景: '冷启动', 广告类型: 'banner', 注册用户: 500, 广告收益: 10 },
        { 日期: '2026-06-10', 应用: 'fr006b', 标准广告场景: '冷启动', 广告类型: 'interstitial', 注册用户: 500, 广告收益: 20 },
        { 日期: '2026-06-10', 应用: 'fr006b', 标准广告场景: '热启动', 广告类型: 'banner', 注册用户: 300, 广告收益: 5 },
      ];
