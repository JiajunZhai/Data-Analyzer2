...
用途：数据透视表分析工具，支持 Excel 文件上传、字段拖拽配置、透视表生成与可视化
技术栈：React 19 + TypeScript + Vite + GSAP + @dnd-kit + xlsx + idb
跑测试：npm run lint
...
| 级别 | 名称 | 标志 | 你缺什么 |
|:---:|---|----|----|
| L0 | 裸用 | 没有 AGENT.md | 一切 |
| L1 | 规则层 | 有 AGENT.md + 行为准则 | hooks、自动化 |
